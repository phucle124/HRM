...
const {AllUsersData ,UserByIdData, CreateUser, UpdateUser, DeleteUser, LockUser, AllDepartmentsData, CreateDepartment, DeleteDepartment, EditDepartment, DepartmentByIdData} = require('../services/CRUDService')
...
const LoginHandle = async (req,res) =>{
    ...
    //     return res.render('./admin/index',{users: await getAllUsers()});
